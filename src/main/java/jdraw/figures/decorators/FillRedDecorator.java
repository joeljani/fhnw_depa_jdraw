...
public class FillRedDecorator extends AbstractDecorator {

    public FillRedDecorator(Figure inner, Figure outer) {
        super(inner, outer);
    }
    ...
    public void draw(Graphics g) {
        getInner().draw(new GraphicsDecorator(g));
    }


    /**
     * Inner class which fills graphics red
     */
